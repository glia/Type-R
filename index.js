	    ...
	    Messenger.prototype.stopListening = function (a_source, a, b) {
	        ...
	        if (_listeningTo) {
	            ...
	            if (a_source) {
	                ...
	                if (source) {
	                    if (removeAll)
	                        _listeningTo[a_source.cid] = void 0;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function listSend(head, args) {
	    if (head)
	        for (var _i = 0, head_2 = head; _i < head_2.length; _i++) {
	            var ev = head_2[_i];
	...
	function listSend0(head) {
	    if (head)
	        for (var _i = 0, head_3 = head; _i < head_3.length; _i++) {
	            var ev = head_3[_i];
	...
	function listSend1(head, a) {
	    if (head)
	        for (var _i = 0, head_4 = head; _i < head_4.length; _i++) {
	            var ev = head_4[_i];
	...
	function listSend2(head, a, b) {
	    if (head)
	        for (var _i = 0, head_5 = head; _i < head_5.length; _i++) {
	            var ev = head_5[_i];
	...
	function listSend3(head, a, b, c) {
	    if (head)
	        for (var _i = 0, head_6 = head; _i < head_6.length; _i++) {
	            var ev = head_6[_i];
	...
	function listSend4(head, a, b, c, d) {
	    if (head)
	        for (var _i = 0, head_7 = head; _i < head_7.length; _i++) {
	            var ev = head_7[_i];
